export const proseClasses = [
  ...
  "dark:prose-code:text-neutral-200",
  ...
  "prose-ul:list-(--list-disc-icon)",
  "prose-li:marker:font-icon",
  "prose-li:marker:text-amber-600",
  "dark:prose-li:marker:text-amber-500",
  ...
  "dark:prose-blockquote:border-neutral-600",
  "max-w-none",
].join(" ");
